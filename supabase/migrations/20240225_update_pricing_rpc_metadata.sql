-- SQL Migration: Update pricing RPC with full metadata
...
BEGIN
    ...
    RETURN QUERY
    SELECT 
        p.id, v.id as v_id, p.name, v.sku, v.base_price_cents, v.compare_at_price_cents,
