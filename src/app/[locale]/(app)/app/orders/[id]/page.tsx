...
import { ArrowLeft, Package, Truck, CreditCard, Calendar, Info, MapPin } from "lucide-react"
                                ...
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="border-b text-muted-foreground text-[11px] uppercase tracking-wider font-semibold">
                                            ...
                                            <th className="text-right py-3 font-medium">Prix Unit. TTC</th>
                                        ...
                                        {order.order_items.map((item: any) => (
                                            <tr key={item.id} className="group">
                                                ...
                                                <td className="py-4 text-right">
                                                    {(item.gross_unit_price_cents / 100).toFixed(2)} CHF
                                                </td>
                                                <td className="py-4 text-right font-serif font-bold italic">
